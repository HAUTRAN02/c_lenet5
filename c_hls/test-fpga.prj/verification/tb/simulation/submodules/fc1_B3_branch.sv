...
// SystemVerilog created from fc1_B3_branch
...
module fc1_B3_branch (
    ...
    wire [0:0] fc1_B3_branch_enable_q;
    wire [0:0] fc1_B3_branch_enable_not_q;
    ...
    begin
        ...
        else if (fc1_B3_branch_enable_q == 1'b1)
        begin
    ...
    // fc1_B3_branch_enable(LOGICAL,3)
    assign fc1_B3_branch_enable_q = not_valid_or_not_stall_0_q & not_valid_or_not_stall_1_q;
    ...
    // fc1_B3_branch_enable_not(LOGICAL,4)
    assign fc1_B3_branch_enable_not_q = ~ (fc1_B3_branch_enable_q);

    // out_stall_out(GPOUT,24)
    assign out_stall_out = fc1_B3_branch_enable_not_q;
