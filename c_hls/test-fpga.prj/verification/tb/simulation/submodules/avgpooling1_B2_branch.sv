...
// SystemVerilog created from avgpooling1_B2_branch
...
module avgpooling1_B2_branch (
    input wire [0:0] in_c0_exe174,
    ...
    // out_c0_exe174(GPOUT,8)
    assign out_c0_exe174 = in_c0_exe174;
