...
// SystemVerilog created from fc3_B2_branch
...
module fc3_B2_branch (
    input wire [0:0] in_c0_exe136,
    input wire [0:0] in_c0_exe2,
    input wire [31:0] in_c0_exe3,
    input wire [0:0] in_memdep_phi2_pop10,
    ...
    // out_c0_exe136(GPOUT,8)
    assign out_c0_exe136 = in_c0_exe136;
    ...
    // out_memdep_phi2_pop10(GPOUT,11)
    assign out_memdep_phi2_pop10 = in_memdep_phi2_pop10;
