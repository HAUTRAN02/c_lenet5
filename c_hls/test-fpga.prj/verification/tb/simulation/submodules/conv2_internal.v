...
(
   ...
   // INST conv2_internal of conv2_function_wrapper
   conv2_function_wrapper conv2_internal
   (
      .clock(clock),
      .resetn(resetn),
      .in0(in0),
      ...
      .done(done),
      .stall(stall),
      // AVM avm_memdep_conv2
      .avm_memdep_conv2_enable(avmm_0_global_avm_enable[0]),
      .avm_memdep_conv2_read(avmm_0_global_avm_read[0]),
      .avm_memdep_conv2_write(avmm_0_global_avm_write[0]),
      .avm_memdep_conv2_address(avmm_0_global_avm_address[0]),
      .avm_memdep_conv2_writedata(avmm_0_global_avm_writedata[0]),
      .avm_memdep_conv2_byteenable(avmm_0_global_avm_byteenable[0]),
      .avm_memdep_conv2_waitrequest(avmm_0_global_avm_waitrequest[0]),
      .avm_memdep_conv2_readdata(avmm_0_global_avm_readdata[0]),
      .avm_memdep_conv2_readdatavalid(avmm_0_global_avm_readdatavalid[0]),
      .avm_memdep_conv2_burstcount(avmm_0_global_avm_burstcount[0]),
      .avm_memdep_conv2_writeack(avmm_0_global_avm_writeack[0]),
      // AVM avm_pn1_conv2
      .avm_pn1_conv2_enable(avmm_0_global_avm_enable[1]),
      .avm_pn1_conv2_read(avmm_0_global_avm_read[1]),
      .avm_pn1_conv2_write(avmm_0_global_avm_write[1]),
      .avm_pn1_conv2_address(avmm_0_global_avm_address[1]),
      .avm_pn1_conv2_writedata(avmm_0_global_avm_writedata[1]),
      .avm_pn1_conv2_byteenable(avmm_0_global_avm_byteenable[1]),
      .avm_pn1_conv2_waitrequest(avmm_0_global_avm_waitrequest[1]),
      .avm_pn1_conv2_readdata(avmm_0_global_avm_readdata[1]),
      .avm_pn1_conv2_readdatavalid(avmm_0_global_avm_readdatavalid[1]),
      .avm_pn1_conv2_burstcount(avmm_0_global_avm_burstcount[1]),
      .avm_pn1_conv2_writeack(avmm_0_global_avm_writeack[1]),
      // AVM avm_unnamed_conv28_conv2
      .avm_unnamed_conv28_conv2_enable(avmm_0_global_avm_enable[2]),
      .avm_unnamed_conv28_conv2_read(avmm_0_global_avm_read[2]),
      .avm_unnamed_conv28_conv2_write(avmm_0_global_avm_write[2]),
      .avm_unnamed_conv28_conv2_address(avmm_0_global_avm_address[2]),
      .avm_unnamed_conv28_conv2_writedata(avmm_0_global_avm_writedata[2]),
      .avm_unnamed_conv28_conv2_byteenable(avmm_0_global_avm_byteenable[2]),
      .avm_unnamed_conv28_conv2_waitrequest(avmm_0_global_avm_waitrequest[2]),
      .avm_unnamed_conv28_conv2_readdata(avmm_0_global_avm_readdata[2]),
      .avm_unnamed_conv28_conv2_readdatavalid(avmm_0_global_avm_readdatavalid[2]),
      .avm_unnamed_conv28_conv2_burstcount(avmm_0_global_avm_burstcount[2]),
      .avm_unnamed_conv28_conv2_writeack(avmm_0_global_avm_writeack[2]),
      // AVM avm_unnamed_conv29_conv2
      .avm_unnamed_conv29_conv2_enable(avmm_0_global_avm_enable[3]),
      .avm_unnamed_conv29_conv2_read(avmm_0_global_avm_read[3]),
      .avm_unnamed_conv29_conv2_write(avmm_0_global_avm_write[3]),
      .avm_unnamed_conv29_conv2_address(avmm_0_global_avm_address[3]),
      .avm_unnamed_conv29_conv2_writedata(avmm_0_global_avm_writedata[3]),
      .avm_unnamed_conv29_conv2_byteenable(avmm_0_global_avm_byteenable[3]),
      .avm_unnamed_conv29_conv2_waitrequest(avmm_0_global_avm_waitrequest[3]),
      .avm_unnamed_conv29_conv2_readdata(avmm_0_global_avm_readdata[3]),
      .avm_unnamed_conv29_conv2_readdatavalid(avmm_0_global_avm_readdatavalid[3]),
      .avm_unnamed_conv29_conv2_burstcount(avmm_0_global_avm_burstcount[3]),
      .avm_unnamed_conv29_conv2_writeack(avmm_0_global_avm_writeack[3])
   );
   ...
   begin:avmm_0_
      ...
      // INST global_icavmm_0_rw of conv2_internal_ic_167879672483563537
      conv2_internal_ic_167879672483563537 global_icavmm_0_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE conv2_internal_ic_167879672483563537
/////////////////////////////////////////////////////////////////
module conv2_internal_ic_167879672483563537
(
   input logic clock,
