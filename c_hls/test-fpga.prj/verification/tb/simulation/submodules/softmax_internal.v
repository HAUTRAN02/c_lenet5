...
(
   ...
   // INST softmax_internal of softmax_function_wrapper
   softmax_function_wrapper softmax_internal
   (
      .clock(clock),
      .resetn(resetn),
      .in0(in0),
      ...
      .done(done),
      .stall(stall),
      // AVM avm_memdep_softmax
      .avm_memdep_softmax_enable(avmm_0_global_avm_enable[0]),
      .avm_memdep_softmax_read(avmm_0_global_avm_read[0]),
      .avm_memdep_softmax_write(avmm_0_global_avm_write[0]),
      .avm_memdep_softmax_address(avmm_0_global_avm_address[0]),
      .avm_memdep_softmax_writedata(avmm_0_global_avm_writedata[0]),
      .avm_memdep_softmax_byteenable(avmm_0_global_avm_byteenable[0]),
      .avm_memdep_softmax_waitrequest(avmm_0_global_avm_waitrequest[0]),
      .avm_memdep_softmax_readdata(avmm_0_global_avm_readdata[0]),
      .avm_memdep_softmax_readdatavalid(avmm_0_global_avm_readdatavalid[0]),
      .avm_memdep_softmax_burstcount(avmm_0_global_avm_burstcount[0]),
      .avm_memdep_softmax_writeack(avmm_0_global_avm_writeack[0]),
      // AVM avm_unnamed_softmax5_softmax
      .avm_unnamed_softmax5_softmax_enable(avmm_0_global_avm_enable[1]),
      .avm_unnamed_softmax5_softmax_read(avmm_0_global_avm_read[1]),
      .avm_unnamed_softmax5_softmax_write(avmm_0_global_avm_write[1]),
      .avm_unnamed_softmax5_softmax_address(avmm_0_global_avm_address[1]),
      .avm_unnamed_softmax5_softmax_writedata(avmm_0_global_avm_writedata[1]),
      .avm_unnamed_softmax5_softmax_byteenable(avmm_0_global_avm_byteenable[1]),
      .avm_unnamed_softmax5_softmax_waitrequest(avmm_0_global_avm_waitrequest[1]),
      .avm_unnamed_softmax5_softmax_readdata(avmm_0_global_avm_readdata[1]),
      .avm_unnamed_softmax5_softmax_readdatavalid(avmm_0_global_avm_readdatavalid[1]),
      .avm_unnamed_softmax5_softmax_burstcount(avmm_0_global_avm_burstcount[1]),
      .avm_unnamed_softmax5_softmax_writeack(avmm_0_global_avm_writeack[1]),
      // AVM avm_unnamed_softmax7_softmax
      .avm_unnamed_softmax7_softmax_enable(avmm_0_global_avm_enable[2]),
      .avm_unnamed_softmax7_softmax_read(avmm_0_global_avm_read[2]),
      .avm_unnamed_softmax7_softmax_write(avmm_0_global_avm_write[2]),
      .avm_unnamed_softmax7_softmax_address(avmm_0_global_avm_address[2]),
      .avm_unnamed_softmax7_softmax_writedata(avmm_0_global_avm_writedata[2]),
      .avm_unnamed_softmax7_softmax_byteenable(avmm_0_global_avm_byteenable[2]),
      .avm_unnamed_softmax7_softmax_waitrequest(avmm_0_global_avm_waitrequest[2]),
      .avm_unnamed_softmax7_softmax_readdata(avmm_0_global_avm_readdata[2]),
      .avm_unnamed_softmax7_softmax_readdatavalid(avmm_0_global_avm_readdatavalid[2]),
      .avm_unnamed_softmax7_softmax_burstcount(avmm_0_global_avm_burstcount[2]),
      .avm_unnamed_softmax7_softmax_writeack(avmm_0_global_avm_writeack[2])
   );
   ...
   begin:avmm_0_
      ...
      // INST global_icavmm_0_rw of softmax_internal_ic_16367157499612171411
      softmax_internal_ic_16367157499612171411 global_icavmm_0_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE softmax_internal_ic_16367157499612171411
/////////////////////////////////////////////////////////////////
module softmax_internal_ic_16367157499612171411
(
   input logic clock,
