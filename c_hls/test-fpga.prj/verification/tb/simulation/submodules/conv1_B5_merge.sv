...
// SystemVerilog created from conv1_B5_merge
...
module conv1_B5_merge (
    ...
    output wire [0:0] out_exitcond941_pop291,
    ...
    // out_exitcond1234_pop254(GPOUT,9)
    assign out_exitcond1234_pop254 = in_exitcond1234_pop254_0;

    // out_exitcond941_pop291(GPOUT,10)
    assign out_exitcond941_pop291 = in_exitcond941_pop291_0;

    // out_memdep_8(GPOUT,11)
    assign out_memdep_8 = in_memdep_8_0;

    // out_notcmp1742_pop302(GPOUT,12)
    assign out_notcmp1742_pop302 = in_notcmp1742_pop302_0;

    // out_notcmp2236_pop266(GPOUT,13)
    assign out_notcmp2236_pop266 = in_notcmp2236_pop266_0;
