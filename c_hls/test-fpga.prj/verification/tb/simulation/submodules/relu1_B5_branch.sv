...
// SystemVerilog created from relu1_B5_branch
...
module relu1_B5_branch (
    ...
    wire [0:0] relu1_B5_branch_enable_q;
    wire [0:0] relu1_B5_branch_enable_not_q;
    ...
    begin
        ...
        else if (relu1_B5_branch_enable_q == 1'b1)
        begin
    ...
    // relu1_B5_branch_enable(LOGICAL,25)
    assign relu1_B5_branch_enable_q = not_valid_or_not_stall_0_q & not_valid_or_not_stall_1_q;
    ...
    // relu1_B5_branch_enable_not(LOGICAL,26)
    assign relu1_B5_branch_enable_not_q = ~ (relu1_B5_branch_enable_q);

    // out_stall_out(GPOUT,22)
    assign out_stall_out = relu1_B5_branch_enable_not_q;
