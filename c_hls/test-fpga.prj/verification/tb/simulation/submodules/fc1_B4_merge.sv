...
// SystemVerilog created from fc1_B4_merge
...
module fc1_B4_merge (
    ...
    output wire [0:0] out_exitcond722_pop161,
    ...
    // out_exitcond722_pop161(GPOUT,7)
    assign out_exitcond722_pop161 = in_exitcond722_pop161_0;

    // out_memdep_3(GPOUT,8)
    assign out_memdep_3 = in_memdep_3_0;

    // out_notcmp1223_pop172(GPOUT,9)
    assign out_notcmp1223_pop172 = in_notcmp1223_pop172_0;
