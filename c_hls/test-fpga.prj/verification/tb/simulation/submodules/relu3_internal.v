...
(
   ...
   // INST relu3_internal of relu3_function_wrapper
   relu3_function_wrapper relu3_internal
   (
      .clock(clock),
      .resetn(resetn),
      .in0(in0),
      ...
      .done(done),
      .stall(stall),
      // AVM avm_memdep_relu3
      .avm_memdep_relu3_enable(avmm_0_global_avm_enable[0]),
      .avm_memdep_relu3_read(avmm_0_global_avm_read[0]),
      .avm_memdep_relu3_write(avmm_0_global_avm_write[0]),
      .avm_memdep_relu3_address(avmm_0_global_avm_address[0]),
      .avm_memdep_relu3_writedata(avmm_0_global_avm_writedata[0]),
      .avm_memdep_relu3_byteenable(avmm_0_global_avm_byteenable[0]),
      .avm_memdep_relu3_waitrequest(avmm_0_global_avm_waitrequest[0]),
      .avm_memdep_relu3_readdata(avmm_0_global_avm_readdata[0]),
      .avm_memdep_relu3_readdatavalid(avmm_0_global_avm_readdatavalid[0]),
      .avm_memdep_relu3_burstcount(avmm_0_global_avm_burstcount[0]),
      .avm_memdep_relu3_writeack(avmm_0_global_avm_writeack[0]),
      // AVM avm_unnamed_relu35_relu3
      .avm_unnamed_relu35_relu3_enable(avmm_0_global_avm_enable[1]),
      .avm_unnamed_relu35_relu3_read(avmm_0_global_avm_read[1]),
      .avm_unnamed_relu35_relu3_write(avmm_0_global_avm_write[1]),
      .avm_unnamed_relu35_relu3_address(avmm_0_global_avm_address[1]),
      .avm_unnamed_relu35_relu3_writedata(avmm_0_global_avm_writedata[1]),
      .avm_unnamed_relu35_relu3_byteenable(avmm_0_global_avm_byteenable[1]),
      .avm_unnamed_relu35_relu3_waitrequest(avmm_0_global_avm_waitrequest[1]),
      .avm_unnamed_relu35_relu3_readdata(avmm_0_global_avm_readdata[1]),
      .avm_unnamed_relu35_relu3_readdatavalid(avmm_0_global_avm_readdatavalid[1]),
      .avm_unnamed_relu35_relu3_burstcount(avmm_0_global_avm_burstcount[1]),
      .avm_unnamed_relu35_relu3_writeack(avmm_0_global_avm_writeack[1])
   );
   ...
   begin:avmm_0_
      ...
      // INST global_icavmm_0_rw of relu3_internal_ic_7327381515238153400
      relu3_internal_ic_7327381515238153400 global_icavmm_0_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE relu3_internal_ic_7327381515238153400
/////////////////////////////////////////////////////////////////
module relu3_internal_ic_7327381515238153400
(
   input logic clock,
