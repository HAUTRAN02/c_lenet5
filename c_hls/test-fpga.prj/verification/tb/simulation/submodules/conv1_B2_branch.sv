...
// SystemVerilog created from conv1_B2_branch
...
module conv1_B2_branch (
    input wire [0:0] in_c0_exe176,
    input wire [0:0] in_c0_exe2,
    input wire [31:0] in_c0_exe3,
    input wire [0:0] in_memdep_phi2_pop12,
    ...
    // out_c0_exe176(GPOUT,8)
    assign out_c0_exe176 = in_c0_exe176;
    ...
    // out_memdep_phi2_pop12(GPOUT,11)
    assign out_memdep_phi2_pop12 = in_memdep_phi2_pop12;
