...
// SystemVerilog created from avgpooling1_B5_branch
...
module avgpooling1_B5_branch (
    ...
    wire [0:0] VCC_q;
    wire [0:0] avgpooling1_B5_branch_enable_q;
    wire [0:0] avgpooling1_B5_branch_enable_not_q;
    ...
    begin
        ...
        else if (avgpooling1_B5_branch_enable_q == 1'b1)
        begin
    ...
    // avgpooling1_B5_branch_enable(LOGICAL,2)
    assign avgpooling1_B5_branch_enable_q = not_valid_or_not_stall_0_q & not_valid_or_not_stall_1_q;
    ...
    // avgpooling1_B5_branch_enable_not(LOGICAL,3)
    assign avgpooling1_B5_branch_enable_not_q = ~ (avgpooling1_B5_branch_enable_q);

    // out_stall_out(GPOUT,24)
    assign out_stall_out = avgpooling1_B5_branch_enable_not_q;
