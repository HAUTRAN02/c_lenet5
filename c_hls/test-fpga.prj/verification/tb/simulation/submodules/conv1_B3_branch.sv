...
// SystemVerilog created from conv1_B3_branch
...
module conv1_B3_branch (
    input wire [0:0] in_c0_exe185,
    input wire [0:0] in_c0_exe286,
    input wire [31:0] in_c0_exe387,
    input wire [0:0] in_c0_exe488,
    ...
    // out_c0_exe185(GPOUT,12)
    assign out_c0_exe185 = in_c0_exe185;

    // out_c0_exe286(GPOUT,13)
    assign out_c0_exe286 = in_c0_exe286;

    // out_c0_exe387(GPOUT,14)
    assign out_c0_exe387 = in_c0_exe387;

    // out_c0_exe488(GPOUT,15)
    assign out_c0_exe488 = in_c0_exe488;
