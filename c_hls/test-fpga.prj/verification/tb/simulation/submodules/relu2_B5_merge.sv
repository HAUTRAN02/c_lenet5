...
// SystemVerilog created from relu2_B5_merge
...
module relu2_B5_merge (
    ...
    output wire [0:0] out_exitcond535_pop291,
    ...
    // out_exitcond535_pop291(GPOUT,9)
    assign out_exitcond535_pop291 = in_exitcond535_pop291_0;

    // out_exitcond828_pop254(GPOUT,10)
    assign out_exitcond828_pop254 = in_exitcond828_pop254_0;

    // out_memdep_8(GPOUT,11)
    assign out_memdep_8 = in_memdep_8_0;

    // out_notcmp1136_pop302(GPOUT,12)
    assign out_notcmp1136_pop302 = in_notcmp1136_pop302_0;

    // out_notcmp1630_pop266(GPOUT,13)
    assign out_notcmp1630_pop266 = in_notcmp1630_pop266_0;
