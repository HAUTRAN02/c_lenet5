...
// SystemVerilog created from avgpooling2_B4_branch
...
module avgpooling2_B4_branch (
    ...
    wire [0:0] VCC_q;
    wire [0:0] avgpooling2_B4_branch_enable_q;
    wire [0:0] avgpooling2_B4_branch_enable_not_q;
    ...
    begin
        ...
        else if (avgpooling2_B4_branch_enable_q == 1'b1)
        begin
    ...
    // avgpooling2_B4_branch_enable(LOGICAL,2)
    assign avgpooling2_B4_branch_enable_q = not_valid_or_not_stall_0_q & not_valid_or_not_stall_1_q;
    ...
    // avgpooling2_B4_branch_enable_not(LOGICAL,3)
    assign avgpooling2_B4_branch_enable_not_q = ~ (avgpooling2_B4_branch_enable_q);

    // out_stall_out(GPOUT,30)
    assign out_stall_out = avgpooling2_B4_branch_enable_not_q;
