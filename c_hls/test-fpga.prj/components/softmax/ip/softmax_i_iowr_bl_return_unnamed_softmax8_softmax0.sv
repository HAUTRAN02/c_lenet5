...
// SystemVerilog created from i_iowr_bl_return_softmax_unnamed_softmax8_softmax0
...
module softmax_i_iowr_bl_return_unnamed_softmax8_softmax0 (
    ...
    assign iowr_i_fifoready = in_iowr_bl_return_softmax_i_fifoready;
    ...
    assign out_iowr_bl_return_softmax_o_fifovalid = iowr_o_fifovalid;
    ...
    assign out_iowr_bl_return_softmax_o_fifodata = iowr_o_fifodata;
