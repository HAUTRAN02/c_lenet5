...
// SystemVerilog created from i_iord_bl_call_conv1_unnamed_conv12_conv10
...
module conv1_i_iord_bl_call_unnamed_conv12_conv10 (
    ...
    // iord(EXTIFACE,7)
    assign iord_i_fifodata = in_iord_bl_call_conv1_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_conv1_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_call_conv1_i_fifodata),
    ...
    assign out_iord_bl_call_conv1_o_fifoready = iord_o_fifoready;

    // regfree_osync(GPOUT,18)
    assign out_iord_bl_call_conv1_o_fifoalmost_full = iord_o_fifoalmost_full;
