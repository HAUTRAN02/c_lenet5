...
// SystemVerilog created from relu2_B4_branch
...
module relu2_B4_branch (
    ...
    wire [0:0] relu2_B4_branch_enable_q;
    wire [0:0] relu2_B4_branch_enable_not_q;
    ...
    begin
        ...
        else if (relu2_B4_branch_enable_q == 1'b1)
        begin
    ...
    // relu2_B4_branch_enable(LOGICAL,31)
    assign relu2_B4_branch_enable_q = not_valid_or_not_stall_0_q & not_valid_or_not_stall_1_q;
    ...
    // relu2_B4_branch_enable_not(LOGICAL,32)
    assign relu2_B4_branch_enable_not_q = ~ (relu2_B4_branch_enable_q);

    // out_stall_out(GPOUT,28)
    assign out_stall_out = relu2_B4_branch_enable_not_q;
