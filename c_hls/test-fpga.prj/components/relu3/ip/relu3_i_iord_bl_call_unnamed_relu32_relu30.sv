...
// SystemVerilog created from i_iord_bl_call_relu3_unnamed_relu32_relu30
...
module relu3_i_iord_bl_call_unnamed_relu32_relu30 (
    ...
    // iord(EXTIFACE,7)
    assign iord_i_fifodata = in_iord_bl_call_relu3_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_relu3_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_call_relu3_i_fifodata),
    ...
    assign out_iord_bl_call_relu3_o_fifoready = iord_o_fifoready;

    // regfree_osync(GPOUT,14)
    assign out_iord_bl_call_relu3_o_fifoalmost_full = iord_o_fifoalmost_full;
