...
// SystemVerilog created from bb_conv2_B5_sr_1
...
module conv2_bb_B5_sr_1 (
    ...
    // combined_valid(LOGICAL,118)
    assign combined_valid_q = in_i_valid | sr_valid_q;

    // stall_and_valid(LOGICAL,121)
