...
// SystemVerilog created from conv2_B2_branch
...
module conv2_B2_branch (
    input wire [0:0] in_c0_exe1426,
    ...
    // out_c0_exe1426(GPOUT,8)
    assign out_c0_exe1426 = in_c0_exe1426;
    ...
    // out_memdep_phi6_pop18(GPOUT,11)
