...
// SystemVerilog created from relu4_B2_branch
...
module relu4_B2_branch (
    ...
    wire [0:0] relu4_B2_branch_enable_q;
    wire [0:0] relu4_B2_branch_enable_not_q;
    ...
    begin
        ...
        else if (relu4_B2_branch_enable_q == 1'b1)
        begin
    ...
    // relu4_B2_branch_enable(LOGICAL,16)
    assign relu4_B2_branch_enable_q = not_valid_or_not_stall_0_q & not_valid_or_not_stall_1_q;

    // VCC(CONSTANT,1)
    assign VCC_q = $unsigned(1'b1);

    // relu4_B2_branch_enable_not(LOGICAL,17)
    assign relu4_B2_branch_enable_not_q = ~ (relu4_B2_branch_enable_q);

    // out_stall_out(GPOUT,13)
    assign out_stall_out = relu4_B2_branch_enable_not_q;
