...
(
   ...
   // INST avgpooling2_internal of avgpooling2_function_wrapper
   avgpooling2_function_wrapper avgpooling2_internal
   (
      .clock(clock),
      .resetn(resetn),
      .in0(in0),
      ...
      .done(done),
      .stall(stall),
      // AVM avm_memdep_avgpooling2
      .avm_memdep_avgpooling2_enable(avmm_0_global_avm_enable[0]),
      .avm_memdep_avgpooling2_read(avmm_0_global_avm_read[0]),
      .avm_memdep_avgpooling2_write(avmm_0_global_avm_write[0]),
      .avm_memdep_avgpooling2_address(avmm_0_global_avm_address[0]),
      .avm_memdep_avgpooling2_writedata(avmm_0_global_avm_writedata[0]),
      .avm_memdep_avgpooling2_byteenable(avmm_0_global_avm_byteenable[0]),
      .avm_memdep_avgpooling2_waitrequest(avmm_0_global_avm_waitrequest[0]),
      .avm_memdep_avgpooling2_readdata(avmm_0_global_avm_readdata[0]),
      .avm_memdep_avgpooling2_readdatavalid(avmm_0_global_avm_readdatavalid[0]),
      .avm_memdep_avgpooling2_burstcount(avmm_0_global_avm_burstcount[0]),
      .avm_memdep_avgpooling2_writeack(avmm_0_global_avm_writeack[0]),
      // AVM avm_unnamed_avgpooling26_avgpooling2
      .avm_unnamed_avgpooling26_avgpooling2_enable(avmm_0_global_avm_enable[1]),
      .avm_unnamed_avgpooling26_avgpooling2_read(avmm_0_global_avm_read[1]),
      .avm_unnamed_avgpooling26_avgpooling2_write(avmm_0_global_avm_write[1]),
      .avm_unnamed_avgpooling26_avgpooling2_address(avmm_0_global_avm_address[1]),
      .avm_unnamed_avgpooling26_avgpooling2_writedata(avmm_0_global_avm_writedata[1]),
      .avm_unnamed_avgpooling26_avgpooling2_byteenable(avmm_0_global_avm_byteenable[1]),
      .avm_unnamed_avgpooling26_avgpooling2_waitrequest(avmm_0_global_avm_waitrequest[1]),
      .avm_unnamed_avgpooling26_avgpooling2_readdata(avmm_0_global_avm_readdata[1]),
      .avm_unnamed_avgpooling26_avgpooling2_readdatavalid(avmm_0_global_avm_readdatavalid[1]),
      .avm_unnamed_avgpooling26_avgpooling2_burstcount(avmm_0_global_avm_burstcount[1]),
      .avm_unnamed_avgpooling26_avgpooling2_writeack(avmm_0_global_avm_writeack[1]),
      // AVM avm_unnamed_avgpooling27_avgpooling2
      .avm_unnamed_avgpooling27_avgpooling2_enable(avmm_0_global_avm_enable[2]),
      .avm_unnamed_avgpooling27_avgpooling2_read(avmm_0_global_avm_read[2]),
      .avm_unnamed_avgpooling27_avgpooling2_write(avmm_0_global_avm_write[2]),
      .avm_unnamed_avgpooling27_avgpooling2_address(avmm_0_global_avm_address[2]),
      .avm_unnamed_avgpooling27_avgpooling2_writedata(avmm_0_global_avm_writedata[2]),
      .avm_unnamed_avgpooling27_avgpooling2_byteenable(avmm_0_global_avm_byteenable[2]),
      .avm_unnamed_avgpooling27_avgpooling2_waitrequest(avmm_0_global_avm_waitrequest[2]),
      .avm_unnamed_avgpooling27_avgpooling2_readdata(avmm_0_global_avm_readdata[2]),
      .avm_unnamed_avgpooling27_avgpooling2_readdatavalid(avmm_0_global_avm_readdatavalid[2]),
      .avm_unnamed_avgpooling27_avgpooling2_burstcount(avmm_0_global_avm_burstcount[2]),
      .avm_unnamed_avgpooling27_avgpooling2_writeack(avmm_0_global_avm_writeack[2]),
      // AVM avm_unnamed_avgpooling28_avgpooling2
      .avm_unnamed_avgpooling28_avgpooling2_enable(avmm_0_global_avm_enable[3]),
      .avm_unnamed_avgpooling28_avgpooling2_read(avmm_0_global_avm_read[3]),
      .avm_unnamed_avgpooling28_avgpooling2_write(avmm_0_global_avm_write[3]),
      .avm_unnamed_avgpooling28_avgpooling2_address(avmm_0_global_avm_address[3]),
      .avm_unnamed_avgpooling28_avgpooling2_writedata(avmm_0_global_avm_writedata[3]),
      .avm_unnamed_avgpooling28_avgpooling2_byteenable(avmm_0_global_avm_byteenable[3]),
      .avm_unnamed_avgpooling28_avgpooling2_waitrequest(avmm_0_global_avm_waitrequest[3]),
      .avm_unnamed_avgpooling28_avgpooling2_readdata(avmm_0_global_avm_readdata[3]),
      .avm_unnamed_avgpooling28_avgpooling2_readdatavalid(avmm_0_global_avm_readdatavalid[3]),
      .avm_unnamed_avgpooling28_avgpooling2_burstcount(avmm_0_global_avm_burstcount[3]),
      .avm_unnamed_avgpooling28_avgpooling2_writeack(avmm_0_global_avm_writeack[3]),
      // AVM avm_unnamed_avgpooling29_avgpooling2
      .avm_unnamed_avgpooling29_avgpooling2_enable(avmm_0_global_avm_enable[4]),
      .avm_unnamed_avgpooling29_avgpooling2_read(avmm_0_global_avm_read[4]),
      .avm_unnamed_avgpooling29_avgpooling2_write(avmm_0_global_avm_write[4]),
      .avm_unnamed_avgpooling29_avgpooling2_address(avmm_0_global_avm_address[4]),
      .avm_unnamed_avgpooling29_avgpooling2_writedata(avmm_0_global_avm_writedata[4]),
      .avm_unnamed_avgpooling29_avgpooling2_byteenable(avmm_0_global_avm_byteenable[4]),
      .avm_unnamed_avgpooling29_avgpooling2_waitrequest(avmm_0_global_avm_waitrequest[4]),
      .avm_unnamed_avgpooling29_avgpooling2_readdata(avmm_0_global_avm_readdata[4]),
      .avm_unnamed_avgpooling29_avgpooling2_readdatavalid(avmm_0_global_avm_readdatavalid[4]),
      .avm_unnamed_avgpooling29_avgpooling2_burstcount(avmm_0_global_avm_burstcount[4]),
      .avm_unnamed_avgpooling29_avgpooling2_writeack(avmm_0_global_avm_writeack[4])
   );
   ...
   begin:avmm_0_
      ...
      // INST global_icavmm_0_rw of avgpooling2_internal_ic_14530760950274062155
      avgpooling2_internal_ic_14530760950274062155 global_icavmm_0_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE avgpooling2_internal_ic_14530760950274062155
/////////////////////////////////////////////////////////////////
module avgpooling2_internal_ic_14530760950274062155
(
   input logic clock,
